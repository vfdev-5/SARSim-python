...
##        dx = self._platform.Vsat / self._platform.PRF
        ...
        self._tArray, self._dt = self._computeRangeTimeArray()
    ...
    def computeRawData(self):
        ...
        self._xSwath = self._computeXSwath()

        if self.verbose:
            print "XBand: ", deltaX
            print "xSwath: ", self._xSwath
        ...
        for target in self.targets:
            ...
            Wa = lambda x : approxWa(x,target[0], self._xSwath)
...
##            HMF = GC.fft(hMF)
    ...
    def _computeXSwath(self):
        thetaX = self._platform.Lambda / self._platform.La
